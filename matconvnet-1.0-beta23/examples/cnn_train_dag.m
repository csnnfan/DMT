...
for t=1:params.batchSize:numel(subset)
  ...
  for s=1:params.numSubBatches
    ...
    % decide whether or not the group loss works
    instanceWeight = inputs{6};
    instanceWeight(instanceWeight == -1) = 0;
    instanceWeight = reshape(instanceWeight,1,1,1,numel(batch));
    net.layers(net.getLayerIndex('objective_group')).block.opts = [...
        net.layers(net.getLayerIndex('objective_group')).block.opts, ...
